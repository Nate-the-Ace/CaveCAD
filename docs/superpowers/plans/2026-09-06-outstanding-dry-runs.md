...
| 6 -- Sketch Scans | `<sha6>` | Put a scan under the drawing without touching the menu bar, twice: once from the cave's own scans folder, once with **Add a scan from elsewhere...**. Is everything a student needs now on the panel, or did you reach for something no longer there? |
